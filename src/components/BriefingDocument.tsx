  ...
  return (
    <div className="transition-all duration-300 relative">
      ...
      <motion.button
        ...
        className="fixed top-20 right-8 z-40 flex items-center gap-2 text-[10px] uppercase tracking-[0.15em] text-muted-foreground border border-border px-4 py-2.5 hover:border-foreground/30 hover:text-foreground transition-colors bg-background/80 backdrop-blur-sm"
      >
