    ...
    <div className="transition-all duration-300 relative">
      ...
      <div className="max-w-[780px] mx-auto px-8 pt-28 pb-28">
        ...
        <motion.button
          ...
          className="flex items-center gap-2 text-[10px] uppercase tracking-[0.15em] text-muted-foreground border border-border px-4 py-2.5 hover:border-foreground/30 hover:text-foreground transition-colors ml-auto mb-6"
        >
