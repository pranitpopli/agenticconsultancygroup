    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-14">
        ...
        <div className="space-y-3">
          {OQR_DATA.financialBreakdown.map((item) => {
        ...
        <p className="text-[11px] text-muted-foreground/70 italic font-serif mt-4">
          {OQR_DATA.cfoSummary}
        </p>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="mb-14">
        ...
        <p className="text-[11px] text-muted-foreground/70 mt-4">
          +{maturityDelta} pts this quarter — {OQR_DATA.departmentsCrossed} departments crossed into AI-Augmented.
        </p>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="mb-14">
        <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mb-5">
          {aiProjects.length} AI-augmented projects · {OQR_DATA.activeDepartmentCount} departments
        </p>
        <div className="grid grid-cols-2 gap-3">
          {aiProjects.slice(0, 6).map((proj) => (
            <div key={proj.id} className="border border-border px-4 py-3 space-y-1.5">
              <p className="text-[12px] text-foreground leading-snug">{proj.name}</p>
        ...
        {aiProjects.length > 6 && (
          <p className="text-[11px] text-muted-foreground/60 mt-3 italic">
            +{aiProjects.length - 6} more across {OQR_DATA.activeDepartmentCount} departments
          </p>
        )}
      </motion.div>
